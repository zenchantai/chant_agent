...
DEFINITION_VERSION = "chan-period-center-free-components-buy-sell-points-v22"
...
REQUIRED_RUNTIME_RULES = {
    ...
    "MOVEMENT-STATUS-001", "CENTER-RELATION-HIERARCHY-001",
    "CENTER-UPGRADE-EXTENSION-001", "CENTER-UPGRADE-EXPANSION-001",
    "CENTER-PARENT-CHILD-001", "MOVEMENT-SHARED-ENDPOINT-001",
    "CENTER-HIERARCHY-THREE-001",
    "COMPONENT-CENTER-FREE-001", "CENTER-COMPONENT-ENTRY-001",
    "CENTER-COMPONENT-CORE-001", "POINT-FIRST-MACD-DUAL-001",
    "POINT-SECOND-RETEST-001", "POINT-THIRD-RETEST-001",
    "MOVEMENT-POINT-CONFIRMATION-001",
}
